...
class SGLangRollout(BaseRollout):
    ...
    def _req_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        for req in sorted_output_req_list:
            ...
            sample_global_indices.append(prompts.non_tensor_batch["sample_global_index"][req.batch_data_id])
        ...
        non_tensor_batch["sample_global_index"] = np.array(sample_global_indices)
